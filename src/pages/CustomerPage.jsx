...
export default function CustomerPage() {
  ...
  useEffect(() => {
    // Check local storage for the temporary auth token generated by /qr/:tableId
    const expiresAtStr = localStorage.getItem(`table_auth_${tableId}`);
    ...
    if (expiresAtStr) {
      ...
      if (Date.now() < expiresAt) {
        ...
        // Token expired
        localStorage.removeItem(`table_auth_${tableId}`);
      }
    }
    setIsScanned(false);
  }, [tableId]);
